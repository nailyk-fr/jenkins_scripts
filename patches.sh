...
cd ~/
repopick -Q "status:open+branch:cm-14.1+project:LineageOS/android_device_sony_msm8974-common" -P device/sony/msm8974-common --exclude "179539,181581,181577,181578,188301,188304,188305"
repopick 181581
repopick 181577
repopick 181578
...
git checkout github/cm-14.1
cd ~/
repopick -Q "status:open+branch:cm-14.1+project:LineageOS/android_device_sony_shinano-common" -P device/sony/shinano-common --exclude "181579,181545,181583,181545,181879,181937,188302,188303"
